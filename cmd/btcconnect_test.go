...
import (
	...
	"github.com/hyperledger/firefly-btcconnect/mocks/ffcservermocks"
...
func TestRunOK(t *testing.T) {
	...
	rootCmd.SetArgs([]string{"-f", "../test/firefly.btcconnect.yaml"})
...
func TestRunUnknownConnector(t *testing.T) {
	...
	rootCmd.SetArgs([]string{"-f", "../test/unknown-connector.btcconnect.yaml"})
	defer rootCmd.SetArgs([]string{})
...
func TestRunBadConfig(t *testing.T) {
	...
	rootCmd.SetArgs([]string{"-f", "../test/bad-config.btcconnect.yaml"})
	defer rootCmd.SetArgs([]string{})
...
func TestRunFailStartup(t *testing.T) {
	rootCmd.SetArgs([]string{"-f", "../test/bad-server.btcconnect.yaml"})
	defer rootCmd.SetArgs([]string{})
